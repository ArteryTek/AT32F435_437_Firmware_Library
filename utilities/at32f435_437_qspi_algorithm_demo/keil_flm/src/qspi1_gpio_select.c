...
void qspi_gpio_slect(void)
{
  ...
  #define QSPI_CS_PIN_SELECT     4
    ...
    #define GPIO_CS_CLOCK_VALUE  1
    #define GPIO_CS_PIN_VALUE    6
    #define GPIO_CS_MUX_VALUE    10
  #elif (QSPI_CS_PIN_SELECT == 1)
    #define GPIO_CS_PORT_VALUE  GPIOB
    #define GPIO_CS_CLOCK_VALUE  1
    #define GPIO_CS_PIN_VALUE    9
    #define GPIO_CS_MUX_VALUE    10
  #elif (QSPI_CS_PIN_SELECT == 2)
    #define GPIO_CS_PORT_VALUE  GPIOB
    #define GPIO_CS_CLOCK_VALUE  1
    #define GPIO_CS_PIN_VALUE    10
    #define GPIO_CS_MUX_VALUE    9
  #elif (QSPI_CS_PIN_SELECT == 3)
    #define GPIO_CS_PORT_VALUE  GPIOC
    #define GPIO_CS_CLOCK_VALUE  2
    #define GPIO_CS_PIN_VALUE    11
    #define GPIO_CS_MUX_VALUE    9
  #elif (QSPI_CS_PIN_SELECT == 4)
    #define GPIO_CS_PORT_VALUE  GPIOG
    #define GPIO_CS_CLOCK_VALUE  6
    #define GPIO_CS_PIN_VALUE    6
    #define GPIO_CS_MUX_VALUE    10
  #endif
  // <o>  QSPI1 SCK pin
  ...
  #define QSPI_SCK_PIN_SELECT     3
    ...
    #define GPIO_SCK_CLOCK_VALUE  1
    #define GPIO_SCK_PIN_VALUE    1
    #define GPIO_SCK_MUX_VALUE    9
  #elif (QSPI_SCK_PIN_SELECT == 1)
    #define GPIO_SCK_PORT_VALUE  GPIOB
    #define GPIO_SCK_CLOCK_VALUE  1
    #define GPIO_SCK_PIN_VALUE    2
    #define GPIO_SCK_MUX_VALUE    9
  #elif (QSPI_SCK_PIN_SELECT == 2)
    #define GPIO_SCK_PORT_VALUE  GPIOD
    #define GPIO_SCK_CLOCK_VALUE  3
    #define GPIO_SCK_PIN_VALUE    3
    #define GPIO_SCK_MUX_VALUE    9
  #elif (QSPI_SCK_PIN_SELECT == 3)
    #define GPIO_SCK_PORT_VALUE  GPIOF
    #define GPIO_SCK_CLOCK_VALUE  5
    #define GPIO_SCK_PIN_VALUE    10
    #define GPIO_SCK_MUX_VALUE    9
  #endif
  // <o>  QSPI1 IO0 pin
  ...
  //  <4=> PF8
  //  <5=> PH2
  #define QSPI_IO0_PIN_SELECT     5
  #if (QSPI_IO0_PIN_SELECT == 0)
    #define GPIO_IO0_PORT_VALUE  GPIOA
    #define GPIO_IO0_CLOCK_VALUE  0
    #define GPIO_IO0_PIN_VALUE    6
    #define GPIO_IO0_MUX_VALUE    10
  #elif (QSPI_IO0_PIN_SELECT == 1)
    #define GPIO_IO0_PORT_VALUE  GPIOB
    #define GPIO_IO0_CLOCK_VALUE  1
    #define GPIO_IO0_PIN_VALUE    0
    #define GPIO_IO0_MUX_VALUE    10
  #elif (QSPI_IO0_PIN_SELECT == 2)
    #define GPIO_IO0_PORT_VALUE  GPIOB
    #define GPIO_IO0_CLOCK_VALUE  1
    #define GPIO_IO0_PIN_VALUE    11
    #define GPIO_IO0_MUX_VALUE    10
  #elif (QSPI_IO0_PIN_SELECT == 3)
    #define GPIO_IO0_PORT_VALUE  GPIOC
    #define GPIO_IO0_CLOCK_VALUE  2
    #define GPIO_IO0_PIN_VALUE    9
    #define GPIO_IO0_MUX_VALUE    9
  #elif (QSPI_IO0_PIN_SELECT == 4)
    #define GPIO_IO0_PORT_VALUE  GPIOF
    #define GPIO_IO0_CLOCK_VALUE  5
    #define GPIO_IO0_PIN_VALUE    8
    #define GPIO_IO0_MUX_VALUE    10
  #elif (QSPI_IO0_PIN_SELECT == 5)
    #define GPIO_IO0_PORT_VALUE  GPIOH
    #define GPIO_IO0_CLOCK_VALUE  7
    #define GPIO_IO0_PIN_VALUE    2
    #define GPIO_IO0_MUX_VALUE    10
  #endif
  // <o>  QSPI1 IO1 pin
  ...
  #define QSPI_IO1_PIN_SELECT     3
    ...
    #define GPIO_IO1_CLOCK_VALUE  0
    #define GPIO_IO1_PIN_VALUE    7
    #define GPIO_IO1_MUX_VALUE    10
  #elif (QSPI_IO1_PIN_SELECT == 1)
    #define GPIO_IO1_PORT_VALUE  GPIOB
    #define GPIO_IO1_CLOCK_VALUE  1
    #define GPIO_IO1_PIN_VALUE    10
    #define GPIO_IO1_MUX_VALUE    10
  #elif (QSPI_IO1_PIN_SELECT == 2)
    #define GPIO_IO1_PORT_VALUE  GPIOF
    #define GPIO_IO1_CLOCK_VALUE  5
    #define GPIO_IO1_PIN_VALUE    9
    #define GPIO_IO1_MUX_VALUE    10
  #elif (QSPI_IO1_PIN_SELECT == 3)
    #define GPIO_IO1_PORT_VALUE  GPIOH
    #define GPIO_IO1_CLOCK_VALUE  7
    #define GPIO_IO1_PIN_VALUE    3
    #define GPIO_IO1_MUX_VALUE    10
  #endif
  // <o>  QSPI1 IO2 pin
  ...
  #define QSPI_IO2_PIN_SELECT     2
    ...
    #define GPIO_IO2_CLOCK_VALUE  0
    #define GPIO_IO2_PIN_VALUE    15
    #define GPIO_IO2_MUX_VALUE    10
  #elif (QSPI_IO2_PIN_SELECT == 1)
    #define GPIO_IO2_PORT_VALUE  GPIOC
    #define GPIO_IO2_CLOCK_VALUE  2
    #define GPIO_IO2_PIN_VALUE    4
    #define GPIO_IO2_MUX_VALUE    10
  #elif (QSPI_IO2_PIN_SELECT == 2)
    #define GPIO_IO2_PORT_VALUE  GPIOC
    #define GPIO_IO2_CLOCK_VALUE  2
    #define GPIO_IO2_PIN_VALUE    8
    #define GPIO_IO2_MUX_VALUE    9
  #elif (QSPI_IO2_PIN_SELECT == 3)
    #define GPIO_IO2_PORT_VALUE  GPIOE
    #define GPIO_IO2_CLOCK_VALUE  4
    #define GPIO_IO2_PIN_VALUE    2
    #define GPIO_IO2_MUX_VALUE    9
  #elif (QSPI_IO2_PIN_SELECT == 4)
    #define GPIO_IO2_PORT_VALUE  GPIOF
    #define GPIO_IO2_CLOCK_VALUE  5
    #define GPIO_IO2_PIN_VALUE    7
    #define GPIO_IO2_MUX_VALUE    9
  #elif (QSPI_IO2_PIN_SELECT == 5)
    #define GPIO_IO2_PORT_VALUE  GPIOG
    #define GPIO_IO2_CLOCK_VALUE  6
    #define GPIO_IO2_PIN_VALUE    9
    #define GPIO_IO2_MUX_VALUE    9
  #endif
  // <o>  QSPI1 IO3 pin
  ...
  #define QSPI_IO3_PIN_SELECT     4
    ...
    #define GPIO_IO3_CLOCK_VALUE  0
    #define GPIO_IO3_PIN_VALUE    1
    #define GPIO_IO3_MUX_VALUE    9
  #elif (QSPI_IO3_PIN_SELECT == 1)
    #define GPIO_IO3_PORT_VALUE  GPIOB
    #define GPIO_IO3_CLOCK_VALUE  1
    #define GPIO_IO3_PIN_VALUE    3
    #define GPIO_IO3_MUX_VALUE    10
  #elif (QSPI_IO3_PIN_SELECT == 2)
    #define GPIO_IO3_PORT_VALUE  GPIOD
    #define GPIO_IO3_CLOCK_VALUE  3
    #define GPIO_IO3_PIN_VALUE    13
    #define GPIO_IO3_MUX_VALUE    9
  #elif (QSPI_IO3_PIN_SELECT == 3)
    #define GPIO_IO3_PORT_VALUE  GPIOF
    #define GPIO_IO3_CLOCK_VALUE  5
    #define GPIO_IO3_PIN_VALUE    6
    #define GPIO_IO3_MUX_VALUE    9
  #elif (QSPI_IO3_PIN_SELECT == 4)
    #define GPIO_IO3_PORT_VALUE  GPIOG
    #define GPIO_IO3_CLOCK_VALUE  6
    #define GPIO_IO3_PIN_VALUE    14
    #define GPIO_IO3_MUX_VALUE    9
  #endif 
  
  CRM->ahben3 |= (uint32_t)(0<<1);
