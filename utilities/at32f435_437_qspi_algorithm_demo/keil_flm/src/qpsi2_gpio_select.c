...
void qspi_gpio_slect(void)
{
  ...
  #define QSPI_SCK_PIN_SELECT     1
    ...
    #define GPIO_SCK_MUX_VALUE    10
  #elif (QSPI_SCK_PIN_SELECT == 1)
    #define GPIO_SCK_PORT_VALUE  GPIOG
    #define GPIO_SCK_CLOCK_VALUE  6
    #define GPIO_SCK_PIN_VALUE    13
    #define GPIO_SCK_MUX_VALUE    5
  #endif
  // <o>  QSPI2 IO0 pin 
  ...
  #define QSPI_IO0_PIN_SELECT     2
    ...
    #define GPIO_IO0_CLOCK_VALUE  4
    #define GPIO_IO0_PIN_VALUE    7
    #define GPIO_IO0_MUX_VALUE    10
  #elif (QSPI_IO0_PIN_SELECT == 2)
    #define GPIO_IO0_PORT_VALUE  GPIOG
    #define GPIO_IO0_CLOCK_VALUE  6
    #define GPIO_IO0_PIN_VALUE    14
    #define GPIO_IO0_MUX_VALUE    5
  #endif
  // <o>  QSPI2 IO1 pin 
  ...
  #define QSPI_IO2_PIN_SELECT     2
    ...
    #define GPIO_IO2_PIN_VALUE    10
    #define GPIO_IO2_MUX_VALUE    5
  #endif
  // <o>  QSPI2 IO3 pin 
