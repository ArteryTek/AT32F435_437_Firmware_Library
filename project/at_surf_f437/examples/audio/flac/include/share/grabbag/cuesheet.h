...
FLAC__StreamMetadata *grabbag__cuesheet_parse(FIL *file, const char **error_message, uint32_t *last_line_read, uint32_t sample_rate, FLAC__bool is_cdda, FLAC__uint64 lead_out_offset);

void grabbag__cuesheet_emit(FIL *file, const FLAC__StreamMetadata *cuesheet, const char *file_reference);
